...
const checkPattern = (userData) => {
  ...
  if (
    ...
    (isFormatValid(userData.date_of_birth, dobPattern) || isFormatValid(userData.date_of_birth, validityPattern2)) &&
  ...
  try {
    if (idImage === undefined || idImage === null || idImage === "") {
      ...
      if (!data) {
        ...
        if (userData.dob === null || userData.name === null || userData.validity === null || data.address === null) {
          res.status(404).send("Please try again")
        }
